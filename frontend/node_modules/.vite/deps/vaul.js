...
} from "./chunk-2MEZRFTM.js";
import "./chunk-NIIQ5B24.js";
import {
  $5e63c961fc1ce211$export$8c6ed5c666ac1360,
  $6ed0406888f73fc4$export$c7b2cbe3552a0d05,
  _extends
} from "./chunk-IGZVFW3P.js";
import {
  require_react
...
var Ee = import_react8.default.createContext({ drawerRef: { current: null }, overlayRef: { current: null }, scaleBackground: () => {
}, onPress: () => {
}, onRelease: () => {
}, onDrag: () => {
}, onNestedDrag: () => {
...
var fe = () => import_react8.default.useContext(Ee);
...
`);
var pt = typeof window != "undefined" ? import_react9.useLayoutEffect : import_react9.useEffect;
function Se(...e) {
  return (...n) => {
    for (let t of e)
...
function ze({ isOpen: e, modal: n, nested: t, hasBeenOpened: r, preventScrollRestoration: a }) {
  let [o, s] = import_react10.default.useState(typeof window != "undefined" ? window.location.href : ""), b = import_react10.default.useRef(0), H = import_react10.default.useCallback(() => {
    if (F === null && e) {
  ...
  }, [e]), x = import_react10.default.useCallback(() => {
    if (F !== null) {
...
var be = 0.4;
function qe(e) {
  let n = import_react12.default.useRef(e);
  return import_react12.default.useEffect(() => {
    n.current = e;
  }), import_react12.default.useMemo(() => (...t) => {
    var r;
    return (r = n.current) == null ? void 0 : r.call(n, ...t);
  }, []);
}
function Rt({ defaultProp: e, onChange: n }) {
  let t = import_react12.default.useState(e), [r] = t, a = import_react12.default.useRef(r), o = qe(n);
  return import_react12.default.useEffect(() => {
...
function Xe({ prop: e, defaultProp: n, onChange: t = () => {
  ...
  let [r, a] = Rt({ defaultProp: n, onChange: t }), o = e !== void 0, s = o ? e : r, b = qe(t), H = import_react12.default.useCallback((x) => {
    if (o) {
...
function Ke({ activeSnapPointProp: e, setActiveSnapPointProp: n, snapPoints: t, drawerRef: r, overlayRef: a, fadeFromIndex: o, onSnapPointChange: s, direction: b = "bottom" }) {
  let [H, x] = Xe({ prop: e, defaultProp: t == null ? void 0 : t[0], onChange: n }), S = import_react11.default.useMemo(() => H === (t == null ? void 0 : t[t.length - 1]) || null, [t, H]), h = t && t.length > 0 && (o || o === 0) && !Number.isNaN(o) && t[o] === H || !t, d = import_react11.default.useMemo(() => t == null ? void 0 : t.findIndex((g) => g === H), [t, H]), u = import_react11.default.useMemo(() => {
    var g;
  ...
  }, [t]), $ = import_react11.default.useMemo(() => d !== null ? u == null ? void 0 : u[d] : null, [u, d]), I = import_react11.default.useCallback((g) => {
    var v;
...
function Ze({ open: e, onOpenChange: n, children: t, shouldScaleBackground: r, onDrag: a, onRelease: o, snapPoints: s, nested: b = false, closeThreshold: H = xt, scrollLockTimeout: x = Ht, dismissible: S = true, fadeFromIndex: h = s && s.length - 1, activeSnapPoint: d, setActiveSnapPoint: u, fixed: $, modal: I = true, onClose: U, direction: f = "bottom", preventScrollRestoration: J = true }) {
  var Ne;
  let [g = false, p] = import_react7.default.useState(false), [v, C] = import_react7.default.useState(false), [A, N] = import_react7.default.useState(false), [P, Q] = import_react7.default.useState(false), [Z, le] = import_react7.default.useState(false), [V, Y] = import_react7.default.useState(false), j = import_react7.default.useRef(null), se = import_react7.default.useRef(null), pe = import_react7.default.useRef(null), Me = import_react7.default.useRef(null), ee = import_react7.default.useRef(null), ue = import_react7.default.useRef(false), ve = import_react7.default.useRef(null), we = import_react7.default.useRef(0), _ = import_react7.default.useRef(false), $e = import_react7.default.useRef(0), l = import_react7.default.useRef(null), Le = import_react7.default.useRef(((Ne = l.current) == null ? void 0 : Ne.getBoundingClientRect().height) || 0), he = import_react7.default.useRef(0), nt = import_react7.default.useCallback((i) => {
  ...
  }, [g, r]), import_react7.default.useEffect(() => {
    e ? (p(true), C(true)) : X();
  }, [e]), import_react7.default.useEffect(() => {
    P && (n == null || n(g));
  }, [g]), import_react7.default.useEffect(() => {
    Q(true);
  }, []);
  function Ie() {
    if (!l.current)
  ...
  return import_react7.default.createElement($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, { modal: I, onOpenChange: (i) => {
    if (e !== void 0) {
      n == null || n(i);
      return;
    }
    i ? (C(true), p(i)) : X();
  }, open: g }, import_react7.default.createElement(Ee.Provider, { value: { visible: A, activeSnapPoint: rt, snapPoints: s, setActiveSnapPoint: Ce, drawerRef: l, overlayRef: j, scaleBackground: ce, onOpenChange: n, onPress: st, setVisible: N, onRelease: ct, onDrag: ut, dismissible: S, isOpen: g, shouldFade: Ae, closeDrawer: X, onNestedDrag: ft, onNestedOpenChange: dt, onNestedRelease: mt, keyboardIsOpen: _, openProp: e, modal: I, snapPointsOffset: ne, direction: f } }, t));
}
var et = import_react7.default.forwardRef(function({ children: e, ...n }, t) {
  let { overlayRef: r, snapPoints: a, onRelease: o, shouldFade: s, isOpen: b, visible: H } = fe(), x = He(t, r), S = a && a.length > 0;
  return import_react7.default.createElement($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff, { onMouseUp: o, ref: x, "vaul-drawer-visible": H ? "true" : "false", "vaul-overlay": "", "vaul-snap-points": b && S ? "true" : "false", "vaul-snap-points-overlay": b && s ? "true" : "false", ...n });
});
et.displayName = "Drawer.Overlay";
var tt = import_react7.default.forwardRef(function({ onOpenAutoFocus: e, onPointerDownOutside: n, onAnimationEnd: t, style: r, ...a }, o) {
  ...
  return import_react7.default.useEffect(() => {
    J(true);
  }, []), import_react7.default.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, { onOpenAutoFocus: (v) => {
    var C;
...
function Mt({ onDrag: e, onOpenChange: n, ...t }) {
  ...
  return import_react7.default.createElement(Ze, { nested: true, onClose: () => {
    a(false);
  }, onDrag: (s, b) => {
    r(s, b), e == null || e(s, b);
  }, onOpenChange: (s) => {
